...
/*/
//--------------------------------------------------------------------
User Function UPDZZJ( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDZZJ" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDZZJ" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'GRUPO PESSOA'															, ; //X2_NOME
	'GRUPO PESSOA'															, ; //X2_NOMESPA
	'GRUPO PESSOA'															, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	"GETSXENUM('ZZJ','ZZJ_CODIGO')"											, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
