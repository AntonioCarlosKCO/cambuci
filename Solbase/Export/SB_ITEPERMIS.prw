...
//------------------------------------------------------------------------
/*/{Protheus.doc} User Function SB_ITEPERMIS
Geração Registro de Permissão de Itens
...
@param 		lWf			, ${param_type}, (Job)
@return 	${return}, ${return_description}
@example	REGISTRO VAZIO

@see (links_or_references)
//------------------------------------------------------------------------
/*/User Function SB_ITEPERMIS( _cLocal, _cFileName, lWf )
