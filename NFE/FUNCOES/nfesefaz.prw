...
If cTipo == "1"
	...
	If MsSeek(xFilial("SF2")+cNota+cSerie+cClieFor+cLoja)
		...
		Else
			...
			cScan := "1"
//*****************************************************************************************************************|
// TRATAMENTO PARA BUSCAR VOLUMES E ESPECIE 5 E 6 - CAIO GARCIA - GLOBALGCS                                        |
//*****************************************************************************************************************|
			                                                                                                     //|
			_cVol5   := Posicione("SC5",1,xFilial("SC5")+SD2->D2_PEDIDO,"C5_ESPECI5")                            //|
			_cVol6   := Posicione("SC5",1,xFilial("SC5")+SD2->D2_PEDIDO,"C5_ESPECI6")                            //|
			_nVol5   := Posicione("SC5",1,xFilial("SC5")+SD2->D2_PEDIDO,"C5_VOLUME5")                            //|
			_nVol6   := Posicione("SC5",1,xFilial("SC5")+SD2->D2_PEDIDO,"C5_VOLUME6")                            //|
                                                                                                                 //|  
//*****************************************************************************************************************|
// FIM DO TRATAMENTO                                                                                               |
//*****************************************************************************************************************|
			...
			EndDo
			//*****************************************************************************************************************|
			// TRATAMENTO PARA ADICIONAR VOLUMES E ESPECIE 5 E 6 NO ARRAY AESPVOL - CAIO GARCIA - GLOBALGCS                    |
			//*****************************************************************************************************************|
			If !Empty(_nVol5)
					aadd(aEspVol,{ _cVol5, _nVol5 , SF2->F2_PLIQUI , SF2->F2_PBRUTO})				
			EndIf		
			If !Empty(_nVol6)
					aadd(aEspVol,{ _cVol6, _nVol6 , SF2->F2_PLIQUI , SF2->F2_PBRUTO})				
			EndIf
			//*****************************************************************************************************************|
			// FIM DO TRATAMENTO                                                                                               |
			//*****************************************************************************************************************|
...
// Tratamento para verificar se o cliente é Semanal
If .t.                                             
...
If  !lIssQn    
	If cMVCODREG == "1" .and. SF4->(FieldPos("F4_CSOSN"))>0 .And. !Empty(SF4->F4_CSOSN)
		...
		If cCsosn$"500" 
		 If !(SM0->M0_ESTENT == "PR" .AND. aDest[9] == "PR" .AND. aProd[7] == "5405")//cambuci
